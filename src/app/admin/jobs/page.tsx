...
const DEMO_JOBS: AdminJob[] = [
  ...
  },
  {
    ...
    status: 'CREATED',
    transportType: 'PALLET',
    description: 'Zahlungsschutz erforderlich',
    route: {
    ...
    shipper: { id: 'shipper_pending', email: 'pending@example.com', name: 'Zahlungsschutz Pending GmbH' },
    transporter: null,
    ...
    operational: {
      ...
      podDocuments: 0,
      invoiceDocuments: 0,
      latestStatusNote: 'Entwurf wartet auf Zahlungsschutz-Reservierung.',
      latestStatusAt: null,
    },
